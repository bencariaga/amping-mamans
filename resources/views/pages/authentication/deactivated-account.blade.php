...
<html lang="en">
    <head>
        ...
        <title>AMPING MAMANS - Account Deactivated</title>
        ...
        <link rel="stylesheet" href="{{ asset('css/pages/authentication/deactivated-account.css') }}">
    </head>
    ...
    <body class="bg-transition" style="display: grid; place-items: center center;">
        ...
        <div class="error-container">
            <div class="error-content">
                ...
                <h1 class="error-code">403 Error</h1>
                <h2 class="error-title">Reason: Forbidden</h2>
                <p class="error-description">You are not allowed to access this system because your account is currently deactivated. Please contact the program head (administrator) to reactivate your account.</p>
        ...
        <script src="{{ asset('js/pages/authentication/deactivated-account.js') }}"></script>
    </body>
</html>
