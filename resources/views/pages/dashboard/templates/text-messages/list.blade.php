...
@section('breadcrumbs')
    ...
    <a href="{{ route('message-templates.list') }}" class="text-decoration-none text-white">Text Message Templates</a>
@endsection
                ...
                <table class="template-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center template-table-header fs-5">Template Text</th>
                    ...
                    <tbody>
                        @foreach($templates as $template)
                            @php
                                $readableText = str_replace(array_keys($labelMap), array_values($labelMap), $template->msg_tmp_text);
                                ...
                                <td class="px-3 py-3 text-center action-buttons">
                                    <div class="gap-3 d-flex justify-content-center">
                                        ...
                                        <form action="{{ route('message-templates.destroy', $template->msg_tmp_id) }}" method="POST" style="display: inline;">
                                            ...
                                            <button class="btn btn-sm btn-danger px-3 py-2 fs-5" style="width: 12rem;" onclick="return confirm('Are you sure you want to delete this SMS template?')">Delete Template</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
