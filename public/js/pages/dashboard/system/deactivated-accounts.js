document.addEventListener('DOMContentLoaded', function () {
    ...
    setupDropdown('sortDropdownBtn', 'filter-sort-by', 'accounts-filter-form');
    setupDropdown('perPageDropdownBtn', 'filter-per-page', 'accounts-filter-form');
    setupDropdown('typeDropdownBtn', 'filter-type', 'accounts-filter-form');
});
