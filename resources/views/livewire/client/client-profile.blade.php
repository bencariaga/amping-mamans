        ...
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="applicantAgeInput" value="{{ (int) $applicant_age }}" readonly>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('profiles.applicants.destroy', ['applicant' => $applicantId]) }}" method="POST">
                    ...
                    <div class="modal-body" id="modal-body">
                        ...
                        <div class="mb-2">
                            <input type="text" name="deleteConfirmationText" class="form-control" id="formControl" required placeholder="{{ Str::of($first_name . ' ' . $last_name)->trim() }}">
                        </div>
                    </div>
