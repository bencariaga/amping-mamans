            ...
            <aside id="sidebar" class="d-flex flex-column sidebar-v1">
                ...
                <div class="sidebar-content">
                    <nav class="d-flex flex-column mt-3 px-3 sidebar-nav">
                        {{-- Dashboard - SYNCHRONIZED: Available to all roles (Program Head, Encoder, etc.) --}}
                        <a class="nav-link @if(request()->routeIs('dashboard')) active @endif" href="{{ route('dashboard') }}">
                            <div class="nav-icon"><i class="fas fa-th-large"></i></div>
                            <div class="nav-text">Dashboard</div>
                        </a>

                        {{-- Program Head Only: Users Management --}}
                        ...
                        {{-- Applicants - SYNCHRONIZED: Available to all roles (Program Head, Encoder, etc.) --}}
                        <a class="nav-link" href="{{ route('profiles.applicants.list') }}">
                            <div class="nav-icon"><i class="fas fa-users"></i></div>
                            <div class="nav-text">Applicants</div>
                        </a>

                        {{-- Program Head Only: Management Submenu --}}
                        @if($role === 'Program Head')
                            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" href="#managementSubmenu" role="button" aria-expanded="false" aria-controls="managementSubmenu">
                        ...
                        {{-- Reports - SYNCHRONIZED: Available to all roles (Program Head, Encoder, etc.) --}}
                        <a class="nav-link" href="{{ route('reports.show', ['type' => 'applications']) }}">
