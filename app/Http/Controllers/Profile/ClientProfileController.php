...
class ClientProfileController extends Controller
{
    ...
    private function loadApplicantData(Applicant $applicant): array
    {
        ...
        \Log::info('Loading applicant data', [
            'applicant_id' => $applicant->applicant_id,
            'total_patients_found' => $patients->count(),
            'patient_ids' => $patients->pluck('patient_id')->toArray()
        ]);
        ...
        // Calculate actual patient count from database
        $actualPatientCount = count($patientsData);
        ...
        return [
            ...
            'patient_number' => $actualPatientCount, // Use actual count from database, not the stored value
