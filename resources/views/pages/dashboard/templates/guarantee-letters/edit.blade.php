...
@section('content')
    <div class="container" id="gl-template-container">
        <form id="gl-template-form" action="{{ route('gl-templates.update', $template) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card template-input-card">
                    ...
                    <div class="details-body">
                        <div class="tmp-title mb-4">
                            ...
                            <input type="text" name="gl_tmp_title" id="gl_tmp_title" class="form-control form-control-lg" placeholder="Example: Guarantee Letter Template 1" maxlength="30" required value="{{ old('gl_tmp_title', $template->gl_tmp_title) }}">
                        ...
                        <input type="hidden" name="signers" id="signers" value="{{ old('signers', $template->signers) }}">
                        <input type="hidden" name="signatures" id="signatures" value="{{ old('signatures', $template->signatures) }}">
                    </div>
                </div>
