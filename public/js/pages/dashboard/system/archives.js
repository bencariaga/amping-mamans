document.addEventListener('DOMContentLoaded', function () {
    ...
    setupDropdown('sortDropdownBtn', 'filter-sort-by', 'archives-filter-form');
    setupDropdown('perPageDropdownBtn', 'filter-per-page', 'archives-filter-form');
    setupDropdown('typeDropdownBtn', 'filter-type', 'archives-filter-form');
});
