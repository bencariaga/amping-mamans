...
class GLController extends Controller
{
    ...
    public function generatePDF($application)
    {
        ...
        // Return HTML view that can be printed to PDF in browser
        // This provides a better user experience similar to the reports
        return view('pages.sidebar.application-entry.guarantee-letter-preview', $data);
    }
}
