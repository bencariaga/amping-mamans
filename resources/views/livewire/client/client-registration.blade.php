<div>
    <form wire:submit.prevent="save" class="profile-section" id="profileSection">
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantSuffixDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ $suffix ?: '— Select —' }}
                        </button>
        ...
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantSexDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ $sex ?: '— Select —' }}
                        </button>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantCivilStatusDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ $civil_status ?: '— Select —' }}
                        </button>
        ...
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantBarangayDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ $barangay ?: '— Select —' }}
                        </button>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantHouseStatusDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantLotStatusDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
				...
				<div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantJobStatusDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ $job_status ?: '— Select —' }}
                        </button>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantOccupationDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false" @if($custom_occupation) disabled @endif>
        ...
        <div class="profile-container">
            <div class="row gx-3 gy-3 mb-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantRepresentingPatientDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantPatientCountDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false" @if($representing_patient === 'Self' || !$representing_patient) disabled @endif>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantPhicAffiliationDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="dropdown">
                        <button id="applicantPhicCategoryDropdownBtn" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false" @if($phic_affiliation !== 'Affiliated') disabled @endif>
                ...
                <div id="patientContainer">
                    @for ($i = 1; $i <= ($patient_count ?? 0); $i++)
                        <div class="patient-profile-section mb-4" id="patient-profile-section-{{$i}}">
                            <hr class="pt-2 pb-2">
                            <legend class="form-legend">
                                <i class="fas fa-hospital-user fa-fw"></i><span class="header-title">NAME OF PATIENT {{ $i }}</span>
                            </legend>

                            <div class="row gx-3 gy-3">
                                <div class="form-group col-md-3">
                                    <label class="form-label fw-bold">First Name <span class="required-asterisk">*</span></label>
                                    <input type="text" wire:model.live="patients.{{$i}}.first_name" id="patientFirstNameInput-{{$i}}" class="form-control" @if(($representing_patient === 'Self' || $representing_patient === 'Self and Other Individual/s') && $i === 1) readonly @endif>
                                    @error("patients.{$i}.first_name") <span class="text-danger mt-3">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label fw-bold">Middle Name</label>
                                    <input type="text" wire:model.live="patients.{{$i}}.middle_name" id="patientMiddleNameInput-{{$i}}" class="form-control" @if(($representing_patient === 'Self' || $representing_patient === 'Self and Other Individual/s') && $i === 1) readonly @endif>
                                    @error("patients.{$i}.middle_name") <span class="text-danger mt-3">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label fw-bold">Last Name <span class="required-asterisk">*</span></label>
                                    <input type="text" wire:model.live="patients.{{$i}}.last_name" id="patientLastNameInput-{{$i}}" class="form-control" @if(($representing_patient === 'Self' || $representing_patient === 'Self and Other Individual/s') && $i === 1) readonly @endif>
                                    @error("patients.{$i}.last_name") <span class="text-danger mt-3">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label fw-bold">Suffix</label>
                                    <div class="dropdown">
                                        <button id="patientSuffixDropdownBtn-{{$i}}" class="btn dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false" @if(($representing_patient === 'Self' || $representing_patient === 'Self and Other Individual/s') && $i === 1) disabled @endif>
                                            {{ $patients[$i]['suffix'] ?: '— Select —' }}
                                        </button>
                                        <ul class="dropdown-menu w-100" aria-labelledby="patientSuffixDropdownBtn-{{$i}}">
