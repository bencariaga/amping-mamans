...
@push('styles')
    <link href="{{ asset('css/pages/sidebar/profiles/list/sponsor-list.css') }}" rel="stylesheet">
@endpush

@push('scripts')
    <script src="{{ asset('js/pages/sidebar/profiles/list/sponsor-list.js') }}"></script>
@endpush
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-3">
                        <div class="filter-search-box me-4">
                            <div class="input-group" id="searchBtn">
                                <input type="text" id="filter-search" name="search" class="form-control fw-bold" placeholder="Search sponsors..." value="{{ request('search') }}">
                                <button class="btn btn-primary fw-bold" type="submit"><i class="fas fa-search me-2"></i>Search</button>
                            </div>
                        </div>
                ...
                <table class="sponsor-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center sponsor-table-header">Total Sponsorship Amount</th>
                            ...
                            <tr class="{{ $loop->even ? 'bg-light' : '' }}">
                                ...
                                <td class="py-2 text-center action-buttons">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="{{ route('sponsors.tables.show', ['id' => $sponsor->sponsor_id]) }}" class="btn btn-sm btn-primary px-3 py-2">
                                            <i class="fas fa-table me-1"></i>View Sponsorships
                                        </a>
                                    </div>
                                </td>
                            </tr>
