document.addEventListener('DOMContentLoaded', function () {
    ...
    setupDropdown('sortDropdownBtn', 'filter-sort-by', 'logs-filter-form');
    setupDropdown('perPageDropdownBtn', 'filter-per-page', 'logs-filter-form');
    setupDropdown('typeDropdownBtn', 'filter-type', 'logs-filter-form');
    setupDropdown('roleDropdownBtn', 'filter-role', 'logs-filter-form');
});
