                            ...
                            <div class="dropdown filter-sort-dropdown">
                                <button id="sortDropdownBtn" class="btn dropdown-toggle custom-dropdown-btn fw-bold" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    {{ collect([
                                        ...
                                        ['value'=>'amount_asc','display'=>'Amount (Low-High)'],
                                        ['value'=>'amount_desc','display'=>'Amount (High-Low)'],
                            ...
                            <tr class="{{ $loop->even ? 'bg-light' : '' }}">
                                ...
                                <td class="py-2 text-center action-buttons">
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        <button class="btn btn-sm btn-success px-3 py-2 authorize-btn" data-application-id="{{ $application->application_id }}" @if($status !== 'Pending') disabled @endif>Approve</button>
                                        <button class="btn btn-sm btn-danger px-3 py-2 reject-btn" data-application-id="{{ $application->application_id }}" @if($status !== 'Pending') disabled @endif>Reject</button>
